...
export default class BroadcastandMessages extends React.Component<IBroadcastandMessagesProps, {}> {
  public render(): React.ReactElement<IBroadcastandMessagesProps> {
    ...
    return (
      <section className={`${styles.broadcastandMessages} ${hasTeamsContext ? styles.teams : ''}`}>
